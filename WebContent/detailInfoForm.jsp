		...
		<div class="container">
			...
			<div class="limiter">
				...
				<div class="wrap-login100 p-l-85 p-r-85 p-t-55 p-b-55"
					...
					<span class="login100-form-title p-b-32"> 부가정보 입력<br>
						<br> <br>
					</span>
					
<div>
${member.name}님을 소개해주세요!
		...
		<form method ="post" enctype="multipart/form-data" class="login100-form validate-form flex-sb flex-w" action="signupAction.sh">
		 ...
		 <input type = "file" name="fname">
					...
					<input type="hidden" name="id" value="${member.id}">
						<span class="txt1 p-b-11"> 한줄소개 </span>
						<div class="wrap-input100 validate-input m-b-12">

							<input class="input100" placeholder="한줄소개를 입력하세요" type="text"
								name="introduction"> <span class="focus-input100"></span>
						</div>
