...
<body>
    ...
    <div class="offcanvas-menu-wrapper">
        ...
        <c:if test="${sessionScope.id!=null}">
         <a href="controller_jsh/logoutAction.sh" class="primary-btn">로그아웃</a>
    ...
    <!-- Hero Section Begin -->
    <section class="hero spad set-bg" data-setbg="/Architecture-kosta202/resources/img/hero-bg.jpg">
        <div class="container">
            <div class="row">
                <div class="col-lg-7">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title">
                        <h2>Our Service</h2>
                        <hr>                        
                        <p>구매 물품을 찾지 말고 이젠 판매견적서를 받아보세요!</p>
                        <p>구매 물품 등록만 하면, 수많은 판매 견적서들이 내품으로!</p>
                        <p>무료로 견적서를 받아보고 거래하고 싶은 판매자와 연락해 보세요.</p>
                    </div>
                </div>
            </div>
            <br><br><br>
