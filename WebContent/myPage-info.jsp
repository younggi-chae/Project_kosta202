				...
				<div class="col-lg-10">
					<div class="header__nav">
						...
						<div class="header__nav__widget">
							...
							<a href="#" class="primary-btn">마이 페이지</a>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="testimonial__item">
						<div class="testimonial__item__author">
							...
							<br><br><br><br><br><br><br>&emsp;
								...
								<br><br>
								<div><input type="button" value="프로필 변경"></div><br><br><br>
								<div><p><a href="#">비밀번호 변경 </a></p></div><br>
								<div><p> <a href="#">계정 삭제</a></p></div><br>								
							</div>							
							<div class="row">
								<div class="col-lg-12 col-md-12 col-sm-12">
								<div class="testimonial__item">											
							<div><h3>개인정보</h3></div><br><br><br>
							<p>이름</p>
							<div><input type="text" value="홍길동"></div><br>
							<p>이메일</p>
							<div><input type="text" value="dudrl5555@naver.com"></div><br>
							<p>전화번호</p>
							<div><input type="text" value="010-0000-0000"></div><br>
							<p>주소</p>
							<div><input type="text" value="서울시 금천구 가산동"></div><br>
							<p>계좌번호</p>
							<div>
							<select>
								<option>신한은행</option>
