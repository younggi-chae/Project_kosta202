...
<!--                             </div> -->
    ...
    <!-- Breadcrumb End -->
    <div class="breadcrumb-option set-bg" data-setbg="/KOSTA_Project/hvac-master/img/breadcrumb-bg.jpg">
        <div class="container">
            <div class="row">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-7 col-md-6">
                    <div class="about__pic">
                       <c:if test="${empty uploadFname}">
                          <a href=""><img src="resources/img/upload_image_kjj.png" alt=""></a>
                       </c:if>
                        <c:if test="${!empty uploadFname}">
                           <a href=""><img src="resources/img/upload_image_kjj.png" alt=""></a>
                        </c:if>
            ...
            <div class="col-lg-5 col-md-6">
               <div class="hero__tab__form">
                  <form action="kjj/registerSellAction.kjj">
                     <div class="select-list">
                        ...
                        <div class="register-row">
									...
									<div>
									<input type="checkbox" name="Type" value="택배거래" style="float: left; width:10%; height: 23px;">
									<p style="float: left;">택배거래</p>
									<input type="checkbox" name="Type" value="직거래" style="float: left; width:10%; height: 23px; margin-left: 20px;">
									<p style="float: left;">직거래</p>
									</div>
								</div>
                        <div class="register-row">
                           <p style="font-size: 20px">거래 지역</p>
                           <input type="text" name="Region" placeholder="필수 입력 사항" style="width: 94%">
                        </div>
                        <div class="select-list-item">
                           <p style="font-size: 20px">대분류</p>
                           <select id="Big_Classifier" name="BigClassifier" onchange="Big_Classifier_select()">
                              <option value="의류">의류</option>
                              <option value="가전">가전</option>
                           </select>
                        </div>
                        <div class="select-list-item">
                           <p style="font-size: 20px">중분류${selectValue}</p>
