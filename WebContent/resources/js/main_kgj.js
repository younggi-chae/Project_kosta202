...
(function ($) {
    ...
    rangeSlider.slider({
        ...
        slide: function (event, ui) {
            $("#amount").val((Math.ceil((ui.values[0] / 1000)) * 1000) + " - " + (Math.ceil((ui.values[1] / 1000)) * 1000));
        }
    });
    ...
    carSlider.slider({
        ...
        values: [50000, 300000],
        slide: function (event, ui) {
            $("#caramount").val((Math.ceil((ui.values[0] / 1000)) * 1000) + " - " + (Math.ceil((ui.values[1] / 1000)) * 1000));
        }
    });
    ...
    filterSlider.slider({
        ...
        values: [50000, 300000],
        slide: function (event, ui) {
            $("#filterAmount").val((Math.ceil((ui.values[0] / 1000)) * 1000) + " - " + (Math.ceil((ui.values[1] / 1000)) * 1000));
        }
    });
