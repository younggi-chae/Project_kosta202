...
public class registerSellAction_kjj implements Action{
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		String savePath = "C:\\Users\\wjdwo\\git\\Project_kosta202\\WebContent\\resources\\img\\upload_kjj";
		int sizeLimit = 1024*1024*15;
		MultipartRequest multi = new MultipartRequest(request, savePath, sizeLimit, "utf-8", new DefaultFileRenamePolicy());
		
		if (multi.getParameter("Region").equals("") || multi.getParameter("ItemName").equals("") || multi.getParameter("Price").equals("") || multi.getParameter("ItemCondition").equals("")) {
			return new ActionForward(true, "registerFormAction.kjj");
		} else {
	        ...
	        sell.setId((String)session.getAttribute("id"));
